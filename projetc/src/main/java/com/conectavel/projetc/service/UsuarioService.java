...
///
    ...
    public Usuario atualizarUsuario(Long id, Usuario usuarioAtualizado) {
        ...
        if (usuarioExistente.isPresent()) {
            ...
            //
            usuario.setSobrenomeUsuario(usuarioAtualizado.getSobrenomeUsuario());
            usuario.setSobreUsuario(usuarioAtualizado.getSobreUsuario());
            usuario.setExperienciaUsuario(usuarioAtualizado.getExperienciaUsuario());
            usuario.setHabilidadeUsuario(usuarioAtualizado.getHabilidadeUsuario());
